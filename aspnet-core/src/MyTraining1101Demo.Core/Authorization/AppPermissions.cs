namespace MyTraining1101Demo.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Tenant_PhoneBook_Phone = "Pages.Tenant.PhoneBook.Phone";
        public const string Pages_Tenant_PhoneBook_Phone_Create = "Pages.Tenant.PhoneBook.Phone.Create";
        public const string Pages_Tenant_PhoneBook_Phone_Delete = "Pages.Tenant.PhoneBook.Phone.Delete";
