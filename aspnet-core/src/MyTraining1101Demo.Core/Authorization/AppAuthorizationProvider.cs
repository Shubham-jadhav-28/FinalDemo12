...
namespace MyTraining1101Demo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var phonePermissions = phoneBook.CreateChildPermission(AppPermissions.Pages_Tenant_PhoneBook_Phone, L("PhoneNumbers"), multiTenancySides: MultiTenancySides.Tenant);
            phonePermissions.CreateChildPermission(AppPermissions.Pages_Tenant_PhoneBook_Phone_Create, L("CreatePhoneNumber"), multiTenancySides: MultiTenancySides.Tenant);
            phonePermissions.CreateChildPermission(AppPermissions.Pages_Tenant_PhoneBook_Phone_Delete, L("DeletePhoneNumber"), multiTenancySides: MultiTenancySides.Tenant);
