...
namespace MyTraining1101Demo.EntityFrameworkCore
{
    public class MyTraining1101DemoDbContext : AbpZeroDbContext<Tenant, Role, User, MyTraining1101DemoDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public virtual DbSet<CustomerUser> CustomersUser { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                b.ToTable("PbPersons");
                //b.ConfigureByConvention(); // Uses audit fields, soft delete, etc.
                b.Property(x => x.Name).IsRequired().HasMaxLength(Person.MaxNameLength);
                b.Property(x => x.Surname).IsRequired().HasMaxLength(Person.MaxSurnameLength);
                b.Property(x => x.EmailAddress).HasMaxLength(Person.MaxEmailAddressLength);
            });
